...
public class BrowserUtils {
    ...
    public static void switchBetweenWindows(String parentWindow) {
        for (String childWindow : Driver.get().getWindowHandles()) {
    ...
    /**
     * Scrolls page up using JavaScript
     *
     * @param element
     */

    public static void scrollUp(WebElement element) {
        ((JavascriptExecutor) Driver.get()).executeScript("window.scrollTo(0,0)", element);
    }
    ...
    public static void selectRandomValueFromListOfWebElements(List<WebElement> list) {
        List<WebElement> newList = new ArrayList<>();
        newList.addAll(0,list);
        Random random = new Random();
        int randomValue = random.nextInt(newList.size());
        newList.get(randomValue).click();
    }
